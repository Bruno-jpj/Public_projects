"""
Django settings for WebTickets project.
...
SECRET_KEY = 'django-insecure-)4u=xz!iik(a#rx$4jrz_=rrhe(5&-+l#nhuj!86hr$#0s5&+('
...
WSGI_APPLICATION = 'WebTickets.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'backend' / 'file_db' / 'WebTicketsDB.db',
    }
}
...
EMAIL_HOST_USER = ''  # La tua email (username)
